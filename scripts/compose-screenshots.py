...
iPhone body with the real screen inside it, one headline and one subline. The
...
FRAMES = [
    ("02b-emergency.png", "store-1-emergency.png", "blue",
     ...
     "Allergies, conditions, every medication. Opens with no signal.",
     TAB_BAR_CROP),
    ("01-today.png", "store-2-today.png", "mint",
     "Know what was taken,\nand who marked it",
     "Today's doses and the family's errands, in one place.",
     TAB_BAR_CROP),
    ("03-detail.png", "store-3-medications.png", "blue",
     "One medication list,\nkept properly",
     "Strength, schedule, what it is for, who prescribed it.",
     TAB_BAR_CROP),
    ("04-tasks.png", "store-4-tasks.png", "sand",
     "Nobody calls the\npharmacy twice",
     "A shared to-do list, so the family can see it is handled.",
     TAB_BAR_CROP),
    ("05-timeline.png", "store-5-timeline.png", "lilac",
     "Two years of history,\nwithout the shoebox",
     "Visits, readings and changes, in the order they happened.",
     TAB_BAR_CROP),
    # The paywall is a sheet: no tab bar, nothing to crop.
    ("07-paywall.png", "store-6-family.png", "rose",
     "Every feature free\nfor one person",
     "Plus adds more people. Invited family members are never charged.",
     0),
]
...
def compose(
    raw_name: str, out_name: str, tint: str, headline: str, subline: str, crop_bottom: int = 0
) -> None:
