#!/usr/bin/env bash
# Deploy the two edge functions to the BabyDocs Supabase project.
#
...
#       APNS_KEY_ID=... APNS_TEAM_ID=... APNS_BUNDLE_ID=com.jackwallner.babydocs \
...
export SUPABASE_ACCESS_TOKEN="$BABYDOCS_SUPABASE_ACCESS_TOKEN"
REF="$BABYDOCS_SUPABASE_PROJECT_REF"
